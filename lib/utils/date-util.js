...
var getQuarterNumber = exports.getQuarterNumber = function getQuarterNumber(date) {
  var m = date.getMonth();
  return Math.floor((m + 3) / 3);
};

// eg: (1) => [0, 1, 2]; (4) => [9, 10, 11]
var getMonthNumberInQuarter = exports.getMonthNumberInQuarter = function getMonthNumberInQuarter(quarter) {
