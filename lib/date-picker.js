...
var HAVE_TRIGGER_TYPES = ['date', 'datetime', 'time', 'time-select', 'week', 'month', 'year', 'yearrange', 'daterange', 'monthrange', 'timerange', 'datetimerange', 'dates', 'quarter', 'quarterrange'];
...
var pickervue_type_script_lang_js_QUARTER_FORMATTER = function QUARTER_FORMATTER(value, format) {
  var quarter = Object(date_util_["getQuarterNumber"])(value);
  var date = Object(date_util_["formatDate"])(value, format);
  if (/Q/.test(date)) {
    date = date.replace(/Q/, quarter);
  }
  return date;
};
var QUARTER_PARSER = function QUARTER_PARSER(value, format) {
  var yearPosition = format.indexOf('yyyy');
  var quarterPosition = format.indexOf('Q');
  var year = /yyyy/.test(format) ? value.substring(yearPosition, yearPosition + 4) : new Date().getFullYear();
  var quarter = value.substring(quarterPosition, quarterPosition + 1);
...
var TYPE_VALUE_RESOLVER_MAP = {
  ...
  week: {
    ...
    parser: function parser(text, format) {
      ...
      var yearPosition = format.indexOf('yyyy');
      var weekPosition = format.indexOf('W') !== -1 ? format.indexOf('W') : format.indexOf('WW');
      var year = /yyyy/.test(format) ? text.substring(yearPosition, yearPosition + 4) : new Date().getFullYear();
      var weeks = isNaN(text.substring(weekPosition, weekPosition + 2)) ? text.substring(weekPosition, weekPosition + 1) : text.substring(weekPosition, weekPosition + 2);
      var timestamp = new Date(year).getTime() + weeks * 7 * 24 * 60 * 60 * 1000;
  ...
  quarter: {
    formatter: pickervue_type_script_lang_js_QUARTER_FORMATTER,
  ...
  quarterrange: {
    formatter: function formatter(value, format) {
      if (Array.isArray(value) && value.length === 2) {
        ...
        if (start && end) {
          return [pickervue_type_script_lang_js_QUARTER_FORMATTER(start, format), pickervue_type_script_lang_js_QUARTER_FORMATTER(end, format)];
        }
      }
      return '';
    },
...
var year_tablevue_type_template_id_c86ab5e0_render = function() {
  ...
  return _c(
    "table",
    {
      ...
      on: { click: _vm.handleYearTableClick, mousemove: _vm.handleMouseMove }
    },
    [
      _c("tbody", [
        _c("tr", [
  ...
  methods: {
    getCellStyle: function getCellStyle(year) {
      ...
      if (this.selectionMode === 'range') {
        var minYear = this.minDate;
        var maxYear = this.rangeState.endDate ? this.rangeState.endDate : this.maxDate;
        var _ref = [Math.min(minYear, maxYear), Math.max(minYear, maxYear)];
        minYear = _ref[0];
        maxYear = _ref[1];
    ...
    handleYearTableClick: function handleYearTableClick(event) {
      ...
      /* istanbul ignore if  */
      var year = Number(target.textContent || target.innerText);
      if (this.selectionMode === 'range') {
...
var quarter_tablevue_type_template_id_2ddeafea_render = function() {
  ...
  return _c(
    "table",
    {
      staticClass: "el-quarter-table",
      on: { click: _vm.handleQuarterTableClick, mousemove: _vm.handleMouseMove }
    },
    [
      _c(
        "tbody",
            ...
            _vm._l(row, function(cell, key) {
              return _c(
                "td",
                {
                  ...
                  attrs: { cellNum: _vm.quarter[cell.text] }
                },
                [
                  _c("div", [
                    _c("a", { staticClass: "cell" }, [
                      _vm._v(
                        _vm._s(
                          _vm.t(
                            "el.datepicker.quarter" + _vm.quarter[cell.text]
                          )
                        )
                      )
                    ])
...
var quarter_tablevue_type_script_lang_js_datesInQuarter = function datesInQuarter(year, quarter) {
  var monthList = Object(date_util_["getMonthNumberInQuarter"])(quarter);
  var numOfDays = monthList.map(function (m) {
    return Object(date_util_["getDayCountOfMonth"])(year, m);
  }).reduce(function (prev, cur) {
    return prev + cur;
  }, 0);
  var firstDay = new Date(year, monthList[0], 1);
  return Object(date_util_["range"])(numOfDays).map(function (n) {
    return Object(date_util_["nextDate"])(firstDay, n);
  });
};
...
/* harmony default export */ var quarter_tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getCellStyle: function getCellStyle(cell) {
      ...
      var style = {};
      var year = this.date.getFullYear();
      var monthList = Object(date_util_["getMonthNumberInQuarter"])(cell.text + 1);
      // const month = cell.text * 3;
      var defaultValue = this.defaultValue ? Array.isArray(this.defaultValue) ? this.defaultValue : [this.defaultValue] : [];
      var monthMatch = function monthMatch(month) {
        return monthList.some(function (item) {
          return item === month;
        });
      };
      var quarter = new Date(this.date.getFullYear(), monthList[0]);
      var today = new Date();
      style.disabled = typeof this.disabledDate === 'function' ? quarter_tablevue_type_script_lang_js_datesInQuarter(quarter.getFullYear(), cell.text + 1).every(this.disabledDate) : false;
      style.current = Object(util_["arrayFindIndex"])(Object(util_["coerceTruthyValueToArray"])(this.value), function (date) {
        return date.getFullYear() === year && monthMatch(date.getMonth());
      }) >= 0;
    ...
    getDateOfQuarter: function getDateOfQuarter(quarter) {
      var year = this.date.getFullYear();
      var month = quarter * 3 - 3;
      return new Date(year, month, 1);
    },
    markRange: function markRange(minDate, maxDate) {
      minDate = quarter_tablevue_type_script_lang_js_getMonthTimestamp(minDate);
      maxDate = quarter_tablevue_type_script_lang_js_getMonthTimestamp(maxDate) || minDate;
      var _ref = [Math.min(minDate, maxDate), Math.max(minDate, maxDate)];
      minDate = _ref[0];
      maxDate = _ref[1];
    ...
    handleQuarterTableClick: function handleQuarterTableClick(event) {
      var target = event.target;
      if (target.tagName === 'A') {
        target = target.parentNode.parentNode;
      }
      ...
      if (target.tagName !== 'TD') return;
      if (Object(dom_["hasClass"])(target, 'disabled')) return;
      var quarter = target.getAttribute('cellNum');
      var newDate = this.getDateOfQuarter(quarter);
      if (this.selectionMode === 'range') {
        if (!this.rangeState.selecting) {
          this.$emit('pick', { minDate: newDate, maxDate: null });
          this.rangeState.selecting = true;
    ...
    rows: function rows() {
      ...
      for (var i = 0; i < 2; i++) {
        ...
        var _loop = function _loop(j) {
          ...
          var index = i * 2 + j;
          var time = new Date(_this2.date.getFullYear(), index * 3).getTime();
          var nextTime = new Date(_this2.date.getFullYear(), index * 3 + 3).getTime();
          cell.inRange = time >= quarter_tablevue_type_script_lang_js_getMonthTimestamp(_this2.minDate) && time <= quarter_tablevue_type_script_lang_js_getMonthTimestamp(_this2.maxDate);
          cell.start = _this2.minDate && time === quarter_tablevue_type_script_lang_js_getMonthTimestamp(_this2.minDate);
          cell.end = _this2.maxDate && time === quarter_tablevue_type_script_lang_js_getMonthTimestamp(_this2.maxDate);
          var isToday = now >= time && now < nextTime;
...
/* harmony default export */ var datevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleQuarterPick: function handleQuarterPick(quarter) {
      var month = quarter * 3 - 3;
  ...
  components: {
    TimePicker: panel_time["a" /* default */], YearTable: year_table, MonthTable: month_table, DateTable: date_table, ElInput: input_default.a, ElButton: button_default.a, QuarterTable: quarter_table
  },
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/date-picker/src/panel/year-range.vue?vue&type=template&id=64fdf669&
var year_rangevue_type_template_id_64fdf669_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var year_rangevue_type_template_id_64fdf669_staticRenderFns = []
year_rangevue_type_template_id_64fdf669_render._withStripped = true


// CONCATENATED MODULE: ./packages/date-picker/src/panel/year-range.vue?vue&type=template&id=64fdf669&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./packages/date-picker/src/panel/year-range.vue?vue&type=script&lang=js&
//
//
//
//
...
var year_rangevue_type_script_lang_js_calcDefaultValue = function calcDefaultValue(defaultValue) {
  var date;
  if (Array.isArray(defaultValue)) {
    return [new Date(defaultValue[0]), new Date(defaultValue[1])];
  } else if (defaultValue) {
...
/* harmony default export */ var year_rangevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    leftLabel: function leftLabel() {
      var startYear = Math.floor(this.date.getFullYear() / 10) * 10;
      var yearTranslation = this.t('el.datepicker.year');
      return startYear + ' ' + yearTranslation + ' - ' + (startYear + 9) + ' ' + yearTranslation;
    },
    rightLabel: function rightLabel() {
      var endYear = Math.floor(this.rightDate.getFullYear() / 10) * 10;
      var yearTranslation = this.t('el.datepicker.year');
  ...
  data: function data() {
    return {
      ...
      popperClass: '',
      defaultValue: null,
      date: year_rangevue_type_script_lang_js_calcDefaultValue(this.defaultValue)[0],
      rightDate: year_rangevue_type_script_lang_js_calcDefaultValue(this.defaultValue)[1],
      minDate: '',
      maxDate: '',
      rangeState: {
        endDate: null,
  ...
  watch: {
    value: {
      handler: function handler(newVal) {
        if (!newVal) {
          ...
          this.minDate = newVal[0] ? Object(date_util_["toDate"])(newVal[0]).getFullYear() : null;
          this.maxDate = newVal[1] ? Object(date_util_["toDate"])(newVal[1]).getFullYear() : null;
    ...
    defaultValue: function defaultValue(val) {
      if (!Array.isArray(this.value) || !this.value.length) {
        var _calcDefaultValue = year_rangevue_type_script_lang_js_calcDefaultValue(val),
            left = _calcDefaultValue[0],
            right = _calcDefaultValue[1];
  ...
  methods: {
    handleClear: function handleClear() {
      this.minDate = null;
      this.maxDate = null;
      this.date = year_rangevue_type_script_lang_js_calcDefaultValue(this.defaultValue)[0];
    ...
    nextYear: function nextYear() {
      ...
      var date = left || !this.unlinkPanels ? this.date : this.rightDate;
    ...
    prevYear: function prevYear() {
      ...
      var date = left ? this.date : this.rightDate;
      date.setFullYear(date.getFullYear() - 10);
      this.resetDate();
    },
    handleConfirm: function handleConfirm() {
...
var year_range_component = Object(componentNormalizer["a" /* default */])(
  panel_year_rangevue_type_script_lang_js_,
  year_rangevue_type_template_id_64fdf669_render,
  year_rangevue_type_template_id_64fdf669_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var year_range_api; }
year_range_component.options.__file = "packages/date-picker/src/panel/year-range.vue"
/* harmony default export */ var year_range = (year_range_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/date-picker/src/panel/quarterrange.vue?vue&type=template&id=cfbd0c66&
var quarterrangevue_type_template_id_cfbd0c66_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var quarterrangevue_type_template_id_cfbd0c66_staticRenderFns = []
quarterrangevue_type_template_id_cfbd0c66_render._withStripped = true


// CONCATENATED MODULE: ./packages/date-picker/src/panel/quarterrange.vue?vue&type=template&id=cfbd0c66&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./packages/date-picker/src/panel/quarterrange.vue?vue&type=script&lang=js&
//
//
//
//
...
var quarterrangevue_type_script_lang_js_calcDefaultValue = function calcDefaultValue(defaultValue) {
  var date;
  if (Array.isArray(defaultValue)) {
    return [new Date(defaultValue[0]), new Date(defaultValue[1])];
  } else if (defaultValue) {
...
/* harmony default export */ var quarterrangevue_type_script_lang_js_ = ({
  mixins: [locale_default.a],
  directives: { Clickoutside: clickoutside_default.a },
  computed: {
    btnDisabled: function btnDisabled() {
  ...
  data: function data() {
    return {
      ...
      popperClass: '',
      defaultValue: null,
      date: quarterrangevue_type_script_lang_js_calcDefaultValue(this.defaultValue)[0],
      minDate: '',
      maxDate: '',
      leftDate: new Date(),
      rightDate: Object(date_util_["nextYear"])(new Date()),
  ...
  watch: {
      ...
      handler: function handler(newVal) {
        if (!newVal) {
          ...
          if (this.minDate) {
            ...
            this.leftDate = quarterrangevue_type_script_lang_js_calcDefaultValue(this.defaultValue)[0];
            this.rightDate = Object(date_util_["nextYear"])(this.leftDate);
          }
    ...
    defaultValue: function defaultValue(val) {
      if (!Array.isArray(this.value)) {
        var _calcDefaultValue = quarterrangevue_type_script_lang_js_calcDefaultValue(val),
            left = _calcDefaultValue[0],
            right = _calcDefaultValue[1];
  ...
  components: {
    quarterTable: quarter_table
  }
});
// CONCATENATED MODULE: ./packages/date-picker/src/panel/quarterrange.vue?vue&type=script&lang=js&
 /* harmony default export */ var panel_quarterrangevue_type_script_lang_js_ = (quarterrangevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./packages/date-picker/src/panel/quarterrange.vue
...
var quarterrange_component = Object(componentNormalizer["a" /* default */])(
  panel_quarterrangevue_type_script_lang_js_,
  quarterrangevue_type_template_id_cfbd0c66_render,
  quarterrangevue_type_template_id_cfbd0c66_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var quarterrange_api; }
quarterrange_component.options.__file = "packages/date-picker/src/panel/quarterrange.vue"
/* harmony default export */ var quarterrange = (quarterrange_component.exports);
